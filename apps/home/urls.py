...
urlpatterns = patterns('aRAT.apps.home.views',
    ...
    url(r'^bandConfiguration$', 'band_configuration_view', name='band_configuration_view'),
    ...
    url(r'^holographyConfiguration$', 'holography_configuration_view', name='holography_configuration_view'),
